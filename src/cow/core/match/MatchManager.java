...
public class MatchManager {
    ...
    public Match createMatch(int playerID1, int playerID2, String sessionID) {
        ...
        if (match == null) {
            ...
            // get players
            players.add(cow.core.GameServer.getInstance().getActivePlayer(playerID1));
            players.add(cow.core.GameServer.getInstance().getActivePlayer(playerID2));
    ...
    public Match matchPlayerTo(int matchID, int playerID) {
        ...
        if (match.addPlayer(cow.core.GameServer.getInstance().getActivePlayer(playerID))) {
